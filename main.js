...
const geometry = new THREE.TorusGeometry(90, 30, 30, 75);
...
pointsMaterial.color = new THREE.Color(0xfffaaa);
// const torus = new THREE.Mesh(geometry, material);
const torus = new THREE.Points(geometry, pointsMaterial);
...
const spaceTexture = new THREE.TextureLoader().load(
  './img/blue-universe-956981-1500x844.jpg'
);
scene.background = spaceTexture;

const profileCubeTexture = new THREE.TextureLoader().load(
  './img/profile_pic_stylized_2.JPG'
);
